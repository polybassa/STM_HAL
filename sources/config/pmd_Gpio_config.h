...
{ {
      ...
      Gpio(Gpio::NWP_HIBERNATE,
           GPIOE_BASE,
           GPIO_InitTypeDef { GPIO_Pin_7, GPIO_Mode_OUT, GPIO_Speed_50MHz, GPIO_OType_PP, GPIO_PuPd_DOWN }),
      Gpio(Gpio::NWP_SUPPLY_N_ENABLE,
           GPIOE_BASE,
           GPIO_InitTypeDef { GPIO_Pin_8, GPIO_Mode_OUT, GPIO_Speed_50MHz, GPIO_OType_PP, GPIO_PuPd_UP }),
      Gpio(Gpio::NWP_SPI_NSS,
           GPIOE_BASE,
           GPIO_InitTypeDef {GPIO_Pin_11, GPIO_Mode_AF, GPIO_Speed_50MHz, GPIO_OType_PP, GPIO_PuPd_UP},
           GPIO_PinSource11,
           GPIO_AF_5),
      Gpio(Gpio::NWP_SPI_SCK,
           GPIOE_BASE,
           GPIO_InitTypeDef {GPIO_Pin_12, GPIO_Mode_AF, GPIO_Speed_50MHz, GPIO_OType_PP, GPIO_PuPd_UP},
           GPIO_PinSource12,
           GPIO_AF_5),
      Gpio(Gpio::NWP_SPI_MISO,
           GPIOE_BASE,
           GPIO_InitTypeDef {GPIO_Pin_13, GPIO_Mode_AF, GPIO_Speed_50MHz, GPIO_OType_PP, GPIO_PuPd_UP},
           GPIO_PinSource13,
           GPIO_AF_5),
      Gpio(Gpio::NWP_SPI_MOSI,
           GPIOE_BASE,
           GPIO_InitTypeDef {GPIO_Pin_14, GPIO_Mode_AF, GPIO_Speed_50MHz, GPIO_OType_PP, GPIO_PuPd_UP},
           GPIO_PinSource14,
           GPIO_AF_5),
      /*  Gpio(Gpio::ENABLE_3V3_SENSE,
             GPIOE_BASE,
             GPIO_InitTypeDef { GPIO_Pin_15, GPIO_Mode_OUT, GPIO_Speed_2MHz, GPIO_OType_PP, GPIO_PuPd_DOWN }),
       */
      // ===================PORTF=================
      Gpio(Gpio::BUZZER,
           GPIOF_BASE,
