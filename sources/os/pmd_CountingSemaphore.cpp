...
#include "pmd_CountingSemaphore.h"

using os::CountingSemaphore;

CountingSemaphore::CountingSemaphore(uint32_t maximalCount, uint32_t initalCount) : mSemaphoreHandle(xSemaphoreCreateCounting(
                                                                                                         maximalCount,
                                                                                                         initalCount))
{}
