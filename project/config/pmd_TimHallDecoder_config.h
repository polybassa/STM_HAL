...
{ {
      HallDecoder(HallDecoder::BLDC_DECODER,
                  ...
                  TIM_OCInitTypeDef { TIM_OCMode_PWM2, TIM_OutputState_Disable, TIM_OutputNState_Disable, 1, TIM_OCPolarity_High, TIM_OCNPolarity_High, TIM_OCIdleState_Reset, TIM_OCNIdleState_Reset},
                  TIM_OCInitTypeDef { TIM_OCMode_PWM2, TIM_OutputState_Disable, TIM_OutputNState_Disable, 0xffff, TIM_OCPolarity_High, TIM_OCNPolarity_High, TIM_OCIdleState_Reset, TIM_OCNIdleState_Reset}
                  )
  } };
