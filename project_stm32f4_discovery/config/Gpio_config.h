...
{ {
      ...
      Gpio(Gpio::PERIOD_MEASUREMENT_1,
           GPIOC_BASE,
           GPIO_InitTypeDef {GPIO_Pin_6, GPIO_Mode_AF, GPIO_Speed_50MHz, GPIO_OType_OD, GPIO_PuPd_NOPULL},
           GPIO_PinSource6,
           GPIO_AF_TIM8),
      Gpio(Gpio::PERIOD_MEASUREMENT_2,
           GPIOC_BASE,
           GPIO_InitTypeDef {GPIO_Pin_7, GPIO_Mode_AF, GPIO_Speed_50MHz, GPIO_OType_OD, GPIO_PuPd_NOPULL},
           GPIO_PinSource7,
           GPIO_AF_TIM8),
