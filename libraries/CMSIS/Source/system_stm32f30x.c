...
#elif STM32F303xC
#define PLL_SOURCE_HSE        // HSI (~8MHz) used to clock the PLL, and the PLL is used as system clock source
#define PLL_SOURCE_HSE_BYPASS                              // WORKAROUND as long as MCO is not supported from JLINK
