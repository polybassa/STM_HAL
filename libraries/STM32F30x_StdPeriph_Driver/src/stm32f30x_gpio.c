...
/**
  ...
  * @retval None
  */
void GPIO_DeInit(GPIO_TypeDef const * const GPIOx)
{
...
/**
  ...
  * @retval None
  */
void GPIO_Init(GPIO_TypeDef * const GPIOx, GPIO_InitTypeDef const * const GPIO_InitStruct)
{ 
...
/**
  ...
  * @retval None
  */
void GPIO_StructInit(GPIO_InitTypeDef * const GPIO_InitStruct)
{
...
/**
  ...
  * @retval None
  */
void GPIO_PinLockConfig(GPIO_TypeDef * const GPIOx, const uint16_t GPIO_Pin)
{
...
/**
  ...
  */
uint8_t GPIO_ReadInputDataBit(GPIO_TypeDef const * const GPIOx, const uint16_t GPIO_Pin)
{
...
/**
  ...
  * @retval The input port pin value.
  */
uint16_t GPIO_ReadInputData(GPIO_TypeDef const * const GPIOx)
{
  /* Check the parameters */
  assert_param(IS_GPIO_ALL_PERIPH(GPIOx));
...
/**
  ...
  */
uint8_t GPIO_ReadOutputDataBit(GPIO_TypeDef const * const GPIOx, const uint16_t GPIO_Pin)
{
  uint8_t bitstatus = 0x00;
...
/**
  ...
  */
uint16_t GPIO_ReadOutputData(GPIO_TypeDef const * const GPIOx)
{
  /* Check the parameters */
  assert_param(IS_GPIO_ALL_PERIPH(GPIOx));
...
/**
  ...
  * @retval None
  */
void GPIO_SetBits(GPIO_TypeDef * const GPIOx, const uint16_t GPIO_Pin)
{
  /* Check the parameters */
  assert_param(IS_GPIO_ALL_PERIPH(GPIOx));
  assert_param(IS_GPIO_PIN(GPIO_Pin));
...
/**
  ...
  * @retval None
  */
void GPIO_ResetBits(GPIO_TypeDef * const GPIOx, const uint16_t GPIO_Pin)
{
  /* Check the parameters */
  assert_param(IS_GPIO_ALL_PERIPH(GPIOx));
  assert_param(IS_GPIO_PIN(GPIO_Pin));
...
/**
  ...
  * @retval None
  */
void GPIO_WriteBit(GPIO_TypeDef * const GPIOx, const uint16_t GPIO_Pin, const BitAction BitVal)
{
  /* Check the parameters */
  assert_param(IS_GPIO_ALL_PERIPH(GPIOx));
  assert_param(IS_GET_GPIO_PIN(GPIO_Pin));
...
/**
  ...
  * @retval None
  */
void GPIO_Write(GPIO_TypeDef * const GPIOx, const uint16_t PortVal)
{
  /* Check the parameters */
  assert_param(IS_GPIO_ALL_PERIPH(GPIOx));
...
/**
  ...
  * @retval None
  */
void GPIO_PinAFConfig(GPIO_TypeDef * const GPIOx, const uint16_t GPIO_PinSource, const uint8_t GPIO_AF)
{
  uint32_t temp = 0x00;
