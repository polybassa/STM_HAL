 ...
 * @retval None
 */
void TIM_TimeBaseInit(TIM_TypeDef* TIMx, const TIM_TimeBaseInitTypeDef* const TIM_TimeBaseInitStruct)
{
    uint16_t tmpcr1 = 0;
 ...
 * @retval None
 */
void TIM_OC1Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef const* const TIM_OCInitStruct)
{
 ...
 * @retval None
 */
void TIM_OC2Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef const* const TIM_OCInitStruct)
{
    uint16_t tmpccmrx = 0, tmpccer = 0, tmpcr2 = 0;
 ...
 * @retval None
 */
void TIM_OC3Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef const* const TIM_OCInitStruct)
{
    uint16_t tmpccmrx = 0, tmpccer = 0, tmpcr2 = 0;
 ...
 * @retval None
 */
void TIM_OC4Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef const* const TIM_OCInitStruct)
{
    uint16_t tmpccmrx = 0, tmpccer = 0, tmpcr2 = 0;
 ...
 * @retval None
 */
void TIM_ICInit(TIM_TypeDef* TIMx, TIM_ICInitTypeDef const* const TIM_ICInitStruct)
{
    /* Check the parameters */
    assert_param(IS_TIM_LIST1_PERIPH(TIMx));
